...
const validationSchema = object({
  ...
  municipio: string("").required("Por favor, ingresa el nombre del municipio"),
  distritoElectoral: number("")
    .required("Por favor, ingresa el número del distrito electoral")
    .max("300")
    .positive("Solo números positivos, por favor.")
    .typeError("Debes ingresar un número")
    .moreThan(1, "Debes ingresar un número mayor a 1"),
...
export const AddBoletaJornada = () => {
  ...
  const values =
    Object.values(jornadaSelected.boletaSelected).length === 0
      ? {
          nombreCandidatura: "",
          municipio: "",
          distritoElectoral: "",
      ...
      : {
          ...
          cargoPrimerFirmante:
            jornadaSelected.boletaSelected.cargoPrimerFirmante,
          segundoFirmante: jornadaSelected.boletaSelected.segundoFirmante,
          cargoSegundoFirmante:
            jornadaSelected.boletaSelected.cargoSegundoFirmante,
        };

  const [isLoading, setIsLoading] = useState(false);

  const [statusMatchModal, setStatusMatchModal] = useState(false);
  const [statusDeletePartidoModal, setStatusDeletePartidoModal] =
    useState(false);
  const [statusDeleteCandidatoModal, setStatusDeleteCandidatoModal] =
    useState(false);
  const [statusRegisterModal, setStatusRegisterModal] = useState(false);

  const handleCloseMatchModal = () => setStatusMatchModal(false);

  const handleCloseDeletePartidoModal = () =>
    setStatusDeletePartidoModal(false);
  const handleCloseDeleteCandidatoModal = () =>
    setStatusDeleteCandidatoModal(false);
          ...
          {({
            ...
            >
              <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  >
                    ...
                    <AddCandidatoMod
                      ...
                      handleOpenDeleteCandidatoModal={
                        handleOpenDeleteCandidatoModal
                      }
                      status={status}
                      valor={propiedad}
                ...
                <ModalBoletaPartido
                  statusMatchModal={statusMatchModal}
                  handleToggleModal={handleCloseMatchModal}
                />
                {/* MODAL PARA REGISTRAR A LOS candidatoandSuplentes Y SUPLENTES */}
                <ModalRegisterCS
                  statusRegisterModal={statusRegisterModal}
                  handleToggleModal={handleCloseRegisterModal}
                />
                {/* MODAL PARA CONFIRMAR LA ELIMINACIÓN */}
                <ModalEliminarPartido
                  statusDeletePartidoModal={statusDeletePartidoModal}
                  handleToggleModal={handleCloseDeletePartidoModal}
                />
                <ModalEliminarCandidato
                  statusDeleteCandidatoModal={statusDeleteCandidatoModal}
                  handleToggleModal={handleCloseDeleteCandidatoModal}
                />
